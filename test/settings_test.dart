...
void main() {
  group("The dark mode switch", () {
    testWidgets("is off if the system's brightness is light.", (WidgetTester tester) async {
      ...
      await tester.pumpWidget(const ProviderScope(child: MaterialApp(home: DarkModeSettingsCard())));
    ...
    testWidgets("is off if the user-defined theme mode is light.", (WidgetTester tester) async {
      await tester.pumpWidget(ProviderScope(
        overrides: [
          appSettingsProvider
              .overrideWithValue(AppSettingsController(appSettings: const AppSettings(themeMode: ThemeMode.light)))
        ],
    ...
    testWidgets("is on if the user-defined theme mode is dark.", (WidgetTester tester) async {
      await tester.pumpWidget(ProviderScope(
        overrides: [
          appSettingsProvider
              .overrideWithValue(AppSettingsController(appSettings: const AppSettings(themeMode: ThemeMode.dark)))
        ],
        child: const MaterialApp(home: DarkModeSettingsCard()),
      ));
